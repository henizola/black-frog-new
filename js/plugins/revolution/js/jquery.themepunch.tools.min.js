...
!(function (a, b) {
  ...
  if (!d.TweenLite) {
    ...
    var z = a.requestAnimationFrame,
      ...
      C = B();
    for (e = ["ms", "moz", "webkit", "o"], f = e.length; --f > -1 && !z; )
        ...
        return (
          "number" !== l &&
            ...
            "string" == typeof k && (g || isNaN(k))
              ...
              : m || ((n.s = parseFloat(k)), (n.c = parseFloat(d) - n.s || 0))),
          n.c
      ...
      (g._initProps = function (b, c, d, e) {
        ...
        for (f in this.vars)
          if (((k = this.vars[f]), T[f]))
            ...
            Q[f] &&
            (i = new Q[f]())._onInitTween(b, this.vars[f], this)
          ) {
            for (
              this._firstPT = j =
                {
    ...
    if (
      ...
      for (g in p)
        p[g].func ||
          a.console.log(
            "GSAP encountered missing dependency: com.greensock." + g
          );
    }
    i = !1;
  }
    ...
    function (a, b, c) {
      ...
      return (
        ...
        (q.add = function (e, f, g, h) {
          var j, k, l, m, n, o;
          if (
            ("number" != typeof f && (f = this._parseTimeOrLabel(f, 0, !0, e)),
            !(e instanceof a))
          ) {
        ...
        (q.render = function (a, b, c) {
          ...
          if ((this._time !== o && this._first) || c || i || l) {
            if (
              ...
              for (
                d = this._first;
                d && ((g = d._next), m === this._time && (!this._paused || r));
  ...
  _gsScope._gsDefine(
    ...
    function (a, b) {
      ...
      var k,
        ...
        $ = (P.calculateOffset = function (a, b, c) {
          ...
          var d = "left" === b ? "Left" : "Top",
            e = Y(a, "margin" + d, c);
          return (
            a["offset" + d] - (Z(a, b, parseFloat(e), e.replace(u, "")) || 0)
          );
        }),
        _ = function (a, b) {
          var c,
      ...
      var na = function (a, b, c, d) {
        ...
        sa = (g.parseComplex = function (a, b, c, d, e, f, h, i, j, l) {
          ...
          for (
            (-1 !== d.indexOf(",") || -1 !== c.indexOf(",")) &&
              ...
              (D = B.length)),
              D !== C.length && ((B = (f || "").split(" ")), (D = B.length)),
              h.plugin = j,
              h.setRatio = l,
              ma.lastIndex = 0,
              m = 0;
            ...
            if (((p = B[m]), (s = C[m]), (v = parseFloat(p)), v || 0 === v))
              h.appendXtra(
                "",
                v,
                fa(s, v),
              ...
              (z = s.indexOf(")") + 1),
                ...
                w && !R && 0 === s[3]
                  ? ((h["xs" + h.l] += h.l ? " transparent" : "transparent"),
                    (h.e = h.e.split(C[m]).join("transparent")))
                  : (R || (w = !1),
                    A
                      ? h
                          .appendXtra(
                      ...
                      : h
                          ...
                          .appendXtra("", p[1], s[1] - p[1], ",", !0)
                          .appendXtra("", p[2], s[2] - p[2], w ? "," : z, !0),
                    w &&
                      ((p = p.length < 4 ? 1 : p[3]),
                      h.appendXtra(
                        "",
        ...
        ta = 9;
      for (j = qa.prototype, j.l = j.pr = 0; --ta > 0; )
        (j["xn" + ta] = 0), (j["xs" + ta] = "");
      (j.xs0 = ""),
        (j._next =
          j._prev =
      ...
      var ua = function (a, b) {
          (b = b || {}),
            ...
            (this.format =
              b.formatter ||
              na(b.defaultValue, b.color, b.collapsible, b.multi)),
      ...
      (j = ua.prototype),
        ...
        (j.parse = function (a, b, c, d, f, g, h) {
          return this.parseComplex(
            a.style,
            this.format(Y(a, this.p, e, !1, this.dflt)),
            this.format(b),
            f,
            g
          );
      ...
      var xa,
        ...
        Da = (P.Transform = function () {
          (this.perspective = parseFloat(g.defaultTransformPerspective) || 0),
            (this.force3D =
              g.defaultForce3D !== !1 && Ca ? g.defaultForce3D || "auto" : !1);
        }),
        ...
        Ha = (function () {
          ...
          return (
            L.createElementNS &&
              !d &&
              ((a = Fa("svg", Ga)),
              (b = Fa("rect", a, { width: 100, height: 50, x: 100 })),
        ...
        Ma = function (a, b) {
          ...
          if (
            ...
            c &&
              za &&
              ((h = "none" === X(a).display) || !a.parentNode) &&
              (h && ((f = k.display), (k.display = "block")),
              a.parentNode || ((g = 1), Ga.appendChild(a)),
              (d = Y(a, Aa, null, !0)),
              (c = !d || "none" === d || "matrix(1, 0, 0, 1, 0, 0)" === d),
              f ? (k.display = f) : h && Ra(k, "display"),
              g && Ga.removeChild(a)),
            (i.svg || (a.getBBox && Ka(a))) &&
              (c &&
                -1 !== (k[za] + "").indexOf("matrix") &&
                ((d = k[za]), (c = 0)),
            ...
            return La;
          for (e = (d || "").match(q) || [], ta = e.length; --ta > -1; )
            (f = Number(e[ta])),
              (e[ta] = (g = f - (f |= 0))
        ...
        Na = (P.getTransform = function (a, c, d, e) {
          ...
          var f,
            ...
            p = 1e5,
            q = Ca
              ? parseFloat(Y(a, Ba, c, !1, "0 0 0").split(" ")[2]) ||
                m.zOrigin ||
                0
              : 0,
            r = parseFloat(g.defaultTransformPerspective) || 0;
          if (
            ((m.svg = !(!a.getBBox || !Ka(a))),
            m.svg &&
              (Ia(
                a,
                Y(a, Ba, c, !1, "50% 50%") + "",
              ...
              for (
                n = d.ieOffsetX || 0,
                  ...
                  d.ieOffsetX = Math.round(
                    (q - ((0 > h ? -h : h) * q + (0 > i ? -i : i) * r)) / 2 + w
                  ),
                  d.ieOffsetY = Math.round(
                    (r - ((0 > k ? -k : k) * r + (0 > j ? -j : j) * q)) / 2 + x
                  ),
                  ta = 0;
                4 > ta;
                ta++
                ...
                (z = ca[ta]),
                  ...
                  (c =
                    -1 !== y.indexOf("px")
                      ? parseFloat(y)
                      : Z(this.t, z, parseFloat(y), y.replace(u, "")) || 0),
                  (A =
                    c !== d[z]
                      ? 2 > ta
                        ? -d.ieOffsetX
      ...
      (j = Da.prototype),
        ...
        va(
          "transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,svgOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent,smoothOrigin",
          {
            parser: function (a, b, c, d, f, h, i) {
              ...
              if (((d._transform = z), "string" == typeof w.transform && za))
                (k = N.style),
                  (k[za] = w.transform),
                  (k.display = "block"),
                  (k.position = "absolute"),
                  ...
                  null != w.xPercent &&
                    (j.xPercent = ga(w.xPercent, z.xPercent)),
                  null != w.yPercent &&
                    (j.yPercent = ga(w.yPercent, z.yPercent));
                ...
                if (
                  ...
                  if ("object" == typeof o) for (k in o) w[k] = o[k];
                  else w.rotation = o;
                "string" == typeof w.x &&
                  -1 !== w.x.indexOf("%") &&
                  ((j.x = 0), (j.xPercent = ga(w.x, z.xPercent))),
                  "string" == typeof w.y &&
                    -1 !== w.y.indexOf("%") &&
                    ((j.y = 0), (j.yPercent = ga(w.y, z.yPercent))),
                  (j.rotation = ha(
                    "rotation" in w
                      ? w.rotation
                      : "shortRotation" in w
                  ...
                  (j.skewY = ha(w.skewY, z.skewY)) &&
                    ((j.skewX += j.skewY), (j.rotation += j.skewY));
              }
              for (
                Ca && null != w.force3D && ((z.force3D = w.force3D), (n = !0)),
                  ...
                  m =
                    ...
                    j.rotationY ||
                    j.perspective,
                  m || null == w.scale || (j.scaleZ = 1);
                --v > -1;

              )
                (c = ya[v]),
                  (l = j[c] - z[c]),
                  (l > u || -u > l || null != w[c] || null != K[c]) &&
                    ((n = !0),
              ...
              return (
                ...
                z.svg &&
                  ...
                  (p !== z.xOffset || q !== z.yOffset) &&
                    ((f = ra(z, "xOffset", s ? p : z.xOffset, z.xOffset, f, y)),
                ...
                n &&
                  (d._transformType =
                    (z.svg && xa) || (!m && 3 !== this._transformType) ? 2 : 3),
                f
              );
            },
            prefix: !0,
          ...
          parser: function (a, b, c, f, g, h) {
            ...
            for (
              ...
              this.p.indexOf("border") && (y[j] = W(y[j])),
                ...
                "" === s && (s = d[c] || t),
                s !== t &&
                  ((v = Z(a, "borderLeft", o, t)),
                  (w = Z(a, "borderTop", o, t)),
                  "%" === s
                    ? ((m = (v / q) * 100 + "%"), (l = (w / r) * 100 + "%"))
                    : "em" === s
                    ? ((x = Z(a, "borderLeft", 1, "em")),
                      (m = v / x + "em"),
                      (l = w / x + "em"))
                    : ((m = v + "px"), (l = w + "px")),
                  u &&
        ...
        va("backgroundPosition", {
          ...
          parser: function (a, b, c, d, f, g) {
            ...
            if (
              ...
              r.split(",").length < 2 &&
              ((m = Y(a, "backgroundImage").replace(B, "")), m && "none" !== m)
            ) {
              for (
                h = q.split(" "),
                  i = r.split(" "),
        ...
        va("backgroundSize", { defaultValue: "0 0", formatter: ea }),
        va("perspective", { defaultValue: "0px", prefix: !0 }),
        va("perspectiveOrigin", { defaultValue: "50% 50%", prefix: !0 }),
        va("transformStyle", { prefix: !0 }),
        va("backfaceVisibility", { prefix: !0 }),
        va("userSelect", { prefix: !0 }),
        va("margin", {
          ...
          parser: function (a, b, c, d, f, g) {
            ...
            return (
              9 > p
                ...
                : ((h = this.format(Y(a, this.p, e, !1, this.dflt))),
                  (b = this.format(b))),
        ...
        va("border", {
          ...
          parser: function (a, b, c, d, f, g) {
            ...
            return (
              "px" !== j &&
                (h = parseFloat(h) / Z(a, "borderTopWidth", 1, j) + j),
              this.parseComplex(
                a.style,
                this.format(
                  h +
                    " " +
                    Y(a, "borderTopStyle", e, !1, "solid") +
                    " " +
                    Y(a, "borderTopColor", e, !1, "#000")
                ),
                i.join(" "),
                f,
                g
      ...
      var Qa = function (a) {
        ...
        100 === e &&
          ...
          -1 === d.indexOf("radient(") &&
          -1 === d.indexOf("oader(")
            ? (c.removeAttribute("filter"), (b = !Y(this.data, "filter")))
      ...
      va("opacity,alpha,autoAlpha", {
        ...
        parser: function (a, b, c, d, f, g) {
          ...
          return (
            ...
            j &&
              1 === h &&
              "hidden" === Y(a, "visibility", e) &&
              0 !== b &&
              (h = 0),
            R
              ? (f = new qa(i, "opacity", h, b - h, f))
              : ((f = new qa(i, "opacity", 100 * h, 100 * (b - h), f)),
                (f.xn1 = j ? 1 : 0),
                (i.zoom = 1),
                (f.type = 2),
      ...
      va("className", {
        parser: function (a, b, d, f, g, h, i) {
          var j,
            ...
            p = a.style.cssText;
          if (
            ((g = f._classNamePT = new qa(a, d, 0, 0, g, 2)),
            (g.setRatio = Sa),
            (g.pr = -11),
            (c = !0),
            (g.b = o),
                  ...
                  (q && y.test(n))
                    ? (q ||
                        ...
                        (n =
                          ...
                          n.join(",") +
                          ")")),
                      (c = sa(s, g, m, n, !0, "transparent", c, 0, f)))
                    : q && H.test(n)
                    ? (c = sa(s, g, m, n, !0, null, c, 0, f))
                    : ((j = parseFloat(m)),
      ...
      var Va = function (a, b, c) {
        var d, e, f, g;
        if (a.slice) for (e = a.length; --e > -1; ) Va(a[e], b, c);
        else
...
!(function (a) {
  ...
  var b = a.GreenSockGlobals || a,
    ...
    u = function (a, b, c, d, h) {
        ...
        for (C = !I || (!G && !H), r = 0; r < F.length; r++) {
          for (
            ...
            "BR" !== k[u].nodeName &&
              ...
              I &&
                (0 === u &&
                  ((z.style.top = x._y + "px"), (z.style.left = M + y + "px")),
                (x.style.top = "0px"),
          ...
          0 === j && (z.innerHTML = "&nbsp;"),
            ...
            I && ((z.style.width = B), (z.style.height = x._h + "px")),
            a.appendChild(z);
        }
        a.style.cssText = A;
      }
      I &&
        (S > a.clientHeight &&
          ((a.style.height = S - P + "px"),
          a.clientHeight < S && (a.style.height = S + N + "px")),
        T > a.clientWidth &&
          ((a.style.width = T - Q + "px"),
